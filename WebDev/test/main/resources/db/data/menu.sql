...
*/
insert into MenuItem(item_name, menu_type, food_type, price, inactive) values ('VEG BIRGYANI', 'INDIAN', 'FOOD', 35.00, 'Y');
insert into MenuItem(item_name, menu_type, food_type, price, inactive) values ('PASTA', 'ITALIAN', 'FOOD', 35.00, 'Y');
